# killemall
A simple server for accessing and writing encrypted data only if the title is known. It contains only 158 lines of code!
...
If you want to use SSL (and you really should), set `ssl.ssl` to true and put the paths of your key and certificate under `ssl.key` and `ssl.cert`.
